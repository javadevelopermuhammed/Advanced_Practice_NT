...
public class S05_MethodOverloading_Kargo {
    ...
    */
    public static void main(String[] args) {
        ...
        System.out.println("Kargo Ucreti: " + kargoUcreti1);
        double kargoUcreti2 = kargoHesapla(35,5);
        System.out.println("Kargo Ucreti: " + kargoUcreti2);
    }

    private static double kargoHesapla(double agirlik, double boyutlar) {
