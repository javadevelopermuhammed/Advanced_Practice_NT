...
public class S03_PassByValue_ArrayDuzenleme {
    ...
    */
    public static void main(String[] args) {
        ...
        harfleriBuyut(isimler);
        harfleriKucult(isimler);
        basinaUnvanEkle("Dr.",isimler);
    }

    private static void basinaUnvanEkle(String unvan,String[] arr) {
        for (String w : arr) {
            w = unvan +" "+w;
            System.out.print(w + "\t");
        }
    ...
    private static void harfleriKucult(String[] arr) {
        for (String w : arr) {
            w = w.toLowerCase();
    ...
    private static void harfleriBuyut(String[] arr) {
        for (String w : arr) {
            w = w.toUpperCase();
            System.out.print(w + "\t");
        }
